...
public class DeleteQnaEleResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("아이디") private String qnaid;           // 아이디
    @ApiModelProperty("상위아이디") private String refid;       // 상위아이디
    @ApiModelProperty("그룹") private double thread;            // 그룹
    @ApiModelProperty("순서") private double pos;               // 순서
    @ApiModelProperty("깊이") private double depth;             // 깊이
    ...
    @ApiModelProperty("답변수") private double repcnt;          // 답변수

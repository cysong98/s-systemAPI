...
@Setter
@ApiModel
public class DeleteUserVgroupReqVO extends AnyXCommonVO implements Serializable {
    // com_vgroup_user
    ...
    @ApiModelProperty("") private String delFlag;              // for ComOrganizationinfoServiceImpl.changeToporgVgroup
}

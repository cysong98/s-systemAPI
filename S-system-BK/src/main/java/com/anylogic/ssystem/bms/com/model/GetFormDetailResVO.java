...
public class GetFormDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<GetFormDetailSelectFileResVO> filelist;        // 카테고리 이름
}

...
public class GetGwanDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty() private List<GetGwanDetailSelectFileResVO> filelist;
}

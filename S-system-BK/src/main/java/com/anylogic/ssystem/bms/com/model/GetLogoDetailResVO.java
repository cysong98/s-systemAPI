...
public class GetLogoDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty() private List<GetLogoDetailSelectFileResVO> filelist;
}
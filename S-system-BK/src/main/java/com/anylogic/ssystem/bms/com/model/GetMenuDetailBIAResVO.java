...
public class GetMenuDetailBIAResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String url;            // 
    @ApiModelProperty("") private String isuse;          //
    @ApiModelProperty("") private String parentMenuid;          //
    @ApiModelProperty("") private String menuorder;          //
}

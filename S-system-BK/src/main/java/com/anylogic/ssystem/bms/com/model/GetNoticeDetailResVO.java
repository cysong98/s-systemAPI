...
public class GetNoticeDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("부서아이디+부서명") private List<SelectNoticeAuthorResVO> deptlist;

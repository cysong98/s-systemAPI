...
public class GetSignDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String isuse;                                // 파일 ID
    @ApiModelProperty("") private String isdefault;                          // 비고
    ...
    @ApiModelProperty() private List<GetSignDetailSelectFileResVO> filelist;
}

...
public class GetUserDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("가상그룹명") private String vgroupname;            // 가상그룹명
    @ApiModelProperty("상세") private String detail;                      // 상세
    @ApiModelProperty("보안유형") private String authtype;                // 보안유형
    @ApiModelProperty("비밀취급인가등급") private String secretgrade;       // 비밀취급인가등급
    @ApiModelProperty("이메일") private String email;                     // 이메일
    @ApiModelProperty("전화번호") private String mobilephone;             // 전화번호
}

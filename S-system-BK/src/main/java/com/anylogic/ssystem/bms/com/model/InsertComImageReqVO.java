...
@Setter
@ApiModel
public class InsertComImageReqVO extends AnyXCommonVO implements Serializable {
    // com_image
    ...
    @ApiModelProperty("파일크기") private BigDecimal filesize;// 파일크기
    ...
    @ApiModelProperty("파일URL") private String fileurl;         // 파일URL

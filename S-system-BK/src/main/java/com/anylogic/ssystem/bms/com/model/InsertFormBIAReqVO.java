...
@Setter
@ApiModel
public class InsertFormBIAReqVO extends AnyXCommonVO implements Serializable {
    // bms_dct_form
    ...
    @ApiModelProperty("서식 크기") private BigDecimal formsize;             // 서식 크기
    ...
    @ApiModelProperty("파일이름") private String filename;
}

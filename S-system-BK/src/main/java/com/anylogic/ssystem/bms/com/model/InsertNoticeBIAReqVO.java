...
@Setter
@ApiModel
public class InsertNoticeBIAReqVO extends AnyXCommonVO implements Serializable {
    // bms_com_notice
...
//    @ApiModelProperty("부서명") private String deptname;      // 부서명
    @ApiModelProperty("부서아이디+부서명") private List<InsertNoticeAuthorReqVO> deptlist;

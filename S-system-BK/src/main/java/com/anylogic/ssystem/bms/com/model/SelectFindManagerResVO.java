...
public class SelectFindManagerResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("사용자순서") private BigDecimal userorder;             // 사용자순서

...
public class SelectFormListResVO extends AnyXCommonVO implements Serializable {
...
//    @ApiModelProperty("카테고리 이름") private String categoryname;        // 카테고리 이름
    @ApiModelProperty("사용자 이름") private String username;        // 카테고리 이름

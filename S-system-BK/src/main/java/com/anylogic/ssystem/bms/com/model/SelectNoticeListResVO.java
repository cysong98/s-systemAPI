...
public class SelectNoticeListResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("공지사항아이디") private String ntcid;    // 공지사항아이디
    ...
    @ApiModelProperty("의견수") private double repcnt;           // 의견수
    ...
    @ApiModelProperty("확인여부") private String cnfmyn;         // 확인여부
    @ApiModelProperty("비고") private String rmk;                // 비고
//    @ApiModelProperty("답변아이디") private String repid;                // 답변아이디
//    @ApiModelProperty("답변내용") private String repcont;                // 답변내용
}

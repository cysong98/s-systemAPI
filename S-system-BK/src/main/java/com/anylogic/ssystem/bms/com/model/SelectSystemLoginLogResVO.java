...
public class SelectSystemLoginLogResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("") private String opid;                            // 
    @ApiModelProperty("") private String userid;                          // 
    @ApiModelProperty("") private String logtime;                         // 
    @ApiModelProperty("") private String gubun;                           // 
    @ApiModelProperty("") private String ip;                              // 
    @ApiModelProperty("") private String neu02rserialnolong;              // 
    @ApiModelProperty("") private String neu02rserialnoshort;             // 
    @ApiModelProperty("") private String kdnid;                           // 

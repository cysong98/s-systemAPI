...
@Setter
@ApiModel
public class UpdateOrganizationBIAReqVO extends AnyXCommonVO implements Serializable {
    // com_organizationinfo
    @ApiModelProperty("조직ID") private String orgid;                  // 조직ID
    @ApiModelProperty("조직이름") private String orgname;              // 조직이름
    @ApiModelProperty("변경 전 조직이름") private String preOrgname;     // 변경 전 조직이름
    ...
    @ApiModelProperty("대표전화번호") private String telephone;
    @ApiModelProperty("대표 FAX") private String fax;
}

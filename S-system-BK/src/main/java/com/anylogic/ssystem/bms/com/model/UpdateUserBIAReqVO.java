...
@Setter
@ApiModel
public class UpdateUserBIAReqVO extends AnyXCommonVO implements Serializable {
    // com_userinfo
...
//    @ApiModelProperty("승인비밀번호") private String approvalpassword;        // 승인비밀번호
    ...
    @ApiModelProperty("가상그룹아이디") private List<SelectUserVgroupResVO> vgrouplist;
    @ApiModelProperty("비밀취급인가등급") private String secretgrade;
    @ApiModelProperty("비밀번호 변경여부") private boolean pwChanged;

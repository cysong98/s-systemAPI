...
public class GetDctRecvResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String distname;               //
    ...
    @ApiModelProperty("") private String recvdata;
}

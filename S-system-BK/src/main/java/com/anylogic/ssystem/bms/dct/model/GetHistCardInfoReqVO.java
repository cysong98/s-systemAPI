...
@Setter
@ApiModel
public class GetHistCardInfoReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("파일순서") private String etcFileOrder;

    @ApiModelProperty("소속코드") private String deptid;

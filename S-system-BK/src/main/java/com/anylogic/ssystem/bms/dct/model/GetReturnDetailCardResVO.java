...
public class GetReturnDetailCardResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("비밀일련번호") private double docnoseq;                    // 비밀일련번호
    ...
    @ApiModelProperty("원 일련번호") private double oriseq;                       // 원 일련번호
    @ApiModelProperty("일괄처리 일련번호") private double batchseq;               // 일괄처리 일련번호
    @ApiModelProperty("종이FLAG") private String paperflag;                       // 종이FLAG
    @ApiModelProperty("본문FLAG") private String maindocflag;                     // 본문FLAG
    @ApiModelProperty("첨부일련번호") private double attachseq;                   // 첨부일련번호
    ...
    @ApiModelProperty("추가발송횟수") private double addsendcnt;                  // 추가발송횟수
    ...
    @ApiModelProperty("시행비밀ID") private String enfdocid;                            // 시행비밀ID
}

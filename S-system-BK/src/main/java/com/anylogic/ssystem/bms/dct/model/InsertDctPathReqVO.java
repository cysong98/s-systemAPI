...
@Setter
@ApiModel
public class InsertDctPathReqVO extends AnyXCommonVO implements Serializable {
    // bms_dct_path
    @ApiModelProperty("비밀 ID") private String docid;                      // 비밀 ID
    @Builder.Default
    @ApiModelProperty("경로순서") private double pathorder = -999999;       // 경로순서
    ...
    @Builder.Default
    @ApiModelProperty("메인버전") private double mainver = -999999;         // 메인버전
    @Builder.Default
    @ApiModelProperty("서브버전") private double subver = -999999;          // 서브버전
    ...
    @Builder.Default
    @ApiModelProperty("재검토경로순서") private double repathorder = -999999;// 재검토경로순서

...
public class InsertDctPathResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("비밀 ID") private String docid;                          // 비밀 ID
    @ApiModelProperty("경로순서") private double pathorder;                     // 경로순서
    ...
    @ApiModelProperty("메인버전") private double mainver;                       // 메인버전
    @ApiModelProperty("서브버전") private double subver;                        // 서브버전
    ...
    @ApiModelProperty("재검토경로순서") private double repathorder;             // 재검토경로순서

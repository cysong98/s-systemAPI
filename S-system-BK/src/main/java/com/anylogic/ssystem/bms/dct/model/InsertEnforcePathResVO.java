...
public class InsertEnforcePathResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertEnforcePathResVO> chargerList;   // 담당자 다건처리 용도
}

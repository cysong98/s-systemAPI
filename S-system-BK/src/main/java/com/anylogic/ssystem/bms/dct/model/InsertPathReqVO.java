...
@Setter
@ApiModel
public class InsertPathReqVO extends AnyXCommonVO implements Serializable {
    // bms_dct_path
    ...
    @ApiModelProperty("메인버전") private int mainver;                      // 메인버전
    @ApiModelProperty("서브버전") private int subver;                       // 서브버전
    ...
    @ApiModelProperty("재검토경로순서") private int repathorder;               // 재검토경로순서

...
@Setter
@ApiModel
public class InsertRecvReqVO extends AnyXCommonVO implements Serializable {
    // bms_dct_appr_recv
    ...
    @ApiModelProperty("") private String sendOrgNameData;                              //
    @ApiModelProperty("") private String sendNameData;

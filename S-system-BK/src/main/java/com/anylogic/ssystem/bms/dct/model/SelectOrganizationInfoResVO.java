...
@ApiModel("selectOrganizationInfo")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectOrganizationInfoResVO extends AnyXCommonVO implements Serializable {
    ...
    // selectManagerInfo 에서 사용
    @ApiModelProperty("") private String vgroupid;
    @ApiModelProperty("") private String vgrouptype;
    @ApiModelProperty("") private String vgroupname;
    @ApiModelProperty("") private String detail;
    @ApiModelProperty("") private String authtype;
}

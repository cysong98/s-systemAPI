...
public class SelectReceiptListResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String regirecvgubun;                              //접수 구분(생산,접수)
    @ApiModelProperty("") private String regirecvtype;                               //구분 ( 전자,비전자)
    @ApiModelProperty("") private String auth;
}

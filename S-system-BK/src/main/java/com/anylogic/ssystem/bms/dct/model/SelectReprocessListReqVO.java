...
@Setter
@ApiModel
public class SelectReprocessListReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("요청 부서")
    @Size(max=35)
    private String acterdeptname;

...
public class SelectReprocessListResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("비밀 구분") private String secgubun;                                      // 비밀 구분
    @ApiModelProperty("비밀 등급") private String seclevel;                                      // 비밀 등급
    @ApiModelProperty("사본 번호") private String copyno;                                        // 사본 번호
    @ApiModelProperty("구분") private String gubun;                                              // 구분
    @ApiModelProperty("RFID 사용 여부") private String rfidtagflag;                              // RFID 사용 여부
    @ApiModelProperty("보존 기간") private String prsrvterm;                                     // 보존 기간
    @ApiModelProperty("원본 보호 기간") private String orgnprotdt;                               // 원본 보호 기간
    @ApiModelProperty("원본 차기 비밀 등급") private String orgnnextlevel;                       // 원본 차기 비밀 등급
    @ApiModelProperty("원본 재분류") private String orgnreclass;                                 // 원본 재분류
    @ApiModelProperty("원본 보호조건") private String orgnprotcond;                              // 원본 보호조건
    @ApiModelProperty("사본 보호기간") private String copyprotdt;                                // 사본 보호기간
    @ApiModelProperty("사본 차기 비밀 등급") private String copynextlevel;                       // 사본 차기 비밀 등급
    @ApiModelProperty("사본 재분류") private String copyreclass;                                 // 사본 재분류
    @ApiModelProperty("사본 보호 조건") private String copyprotcond;                             // 사본 보호 조건
    ...
    @ApiModelProperty("특별관리 여부") private String specialyn;                                 // 특별관리 여부
    @ApiModelProperty("참고철바인더 여부") private String binderyn;                              // 참고철바인더 여부
    ...
    @ApiModelProperty("발송의견") private String sendopinion;

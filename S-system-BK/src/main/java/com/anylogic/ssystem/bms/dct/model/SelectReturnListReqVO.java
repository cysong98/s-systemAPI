...
@Setter
@ApiModel
public class SelectReturnListReqVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("비밀제목")
    @Size(max=500)
    private String doctitle;                     // 비밀제목

    @ApiModelProperty("recvdeptname")
    private String recvdeptname;                 // recvdeptname

    @ApiModelProperty("deptname")
    private String deptname;                 // deptname

    @ApiModelProperty("gubun")

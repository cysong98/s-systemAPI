...
@ApiModel("selectSendCurrentList")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectSendCurrentListResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("발송이력 ID") private String sendhisid;

    @ApiModelProperty("관리번호") private String mgmtno; //관리번호
    @ApiModelProperty("사본번호") private String copyno; //사본번호
    @ApiModelProperty("비밀 등급") private String seclevel; //비밀등급
    @ApiModelProperty("수신부서") private String deptname; //수신부서

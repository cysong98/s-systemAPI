...
@Setter
@ApiModel
public class SelectSendWaitListReqVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("")
    @Size(max=100)
    ...
    @ApiModelProperty("") private String startDt;
    @ApiModelProperty("") private String endDt;

    @ApiModelProperty("수신부서")
    @Size(max=100)
    private String recvdeptnames; //(목록애서 보여질)수신부서

...
public class SelectSendWaitListResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("수신부서") private String recvdeptnames; //(목록애서 보여질)수신부서

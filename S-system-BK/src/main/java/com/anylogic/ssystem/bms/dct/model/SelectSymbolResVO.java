...
public class SelectSymbolResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String cfilename;                              //
    @ApiModelProperty("") private String sfilename;                              //
    @ApiModelProperty("") private BigDecimal filesize;                               //
    @ApiModelProperty("") private String saveid;                                 //
    @ApiModelProperty("") private String filewidth;                              //
    @ApiModelProperty("") private String fileheight;                             //
    @ApiModelProperty("") private String fileurl;                             //
    @ApiModelProperty("") private String filepath;                             //
}

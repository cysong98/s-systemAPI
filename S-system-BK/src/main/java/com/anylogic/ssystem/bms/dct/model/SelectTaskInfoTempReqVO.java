...
@Setter
@ApiModel
public class SelectTaskInfoTempReqVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("문서 ID")
    @Size(max=35)
    private String docid;                     // 문서 ID

    @ApiModelProperty("근거 ID")
    @Size(max=35)
    private String infomationid;                     // 근거 ID
    ...
    @ApiModelProperty("문서 ID")
    @Size(max=35)
    private String oridocid;                     // 문서 ID //사본생성시 원본문서 조회용

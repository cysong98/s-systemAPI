...
public class SelectTaskInfoTempResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("정보출처 ID") private String infomationid;    // 정보출처 ID
    @ApiModelProperty("실적 ID") private String resultid;            // 실적 ID
    @ApiModelProperty("정보출처 제목") private String infotext;      // 정보출처 제목
    @ApiModelProperty("등록자 ID") private String inid;              // 등록자 ID
    @ApiModelProperty("등록일") private String indt;                 // 등록일
    @ApiModelProperty("첨부파일 ID") private String attachid;        // 첨부파일 ID
    @ApiModelProperty("정보출처유형") private String infotype;       // 정보출처유형
    @ApiModelProperty("삭제여부") private String deleteyn;           // 삭제여부
    @ApiModelProperty("정보출처타이틀") private String infotitle;    // 정보출처타이틀
    @ApiModelProperty("") private String sfilename;
...
//    @ApiModelProperty("파일고유이름") private String sfilename;          // 파일고유이름
    ...
    @ApiModelProperty("파일경로") private String flepath;               // 파일경로
//    @ApiModelProperty("등록일") private String indt;                     // 등록일
//    @ApiModelProperty("등록자 ID") private String inid;                  // 등록자 ID

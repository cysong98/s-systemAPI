...
public class SelectTempCreateCardListResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("") private String wargubun;                      //
    @ApiModelProperty("") private List<String> deptNames;                      //
    ...
    @ApiModelProperty("") private String acttype;                   // acttype
    ...
    // bms_dct_rdoc_rcvs
    @ApiModelProperty("") private List<String> rcvsDeptIds;
    @ApiModelProperty("") private List<String> rcvsDeptNames;
    ...
    // bms_dct_mgmt_regi
    @ApiModelProperty("") private String mgmtno;                  // mgmtno ( 관리번호 )
    @ApiModelProperty("") private String copyno;                  // copyno ( 사본번호 )
    ...
    @ApiModelProperty("") private List<SelectDctEnfPathResVO> chargerList;   //chargerList

...
@Setter
@ApiModel
public class SelectToDoListApprReadyReqVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("비밀I D")
    @Size(max=35)
    private String docid;                        // 비밀I D

    @ApiModelProperty("title")
    private String title;                        // title

    @ApiModelProperty("처리구분")
    @Size(max=25)
    private String actgubun;                     // 처리구분

    @ApiModelProperty("보고일자")
    @Size(max=14)
    ...
    @ApiModelProperty("직위직급 이름")
    @Size(max=100)
    private String dutyname;                     // 직위직급 이름

    @ApiModelProperty("proposer")
    private String proposer;                     // proposer

    @ApiModelProperty("발신기관 이름")
    @Size(max=256)
    private String sendorgname;                  // 발신기관 이름

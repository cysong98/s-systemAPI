...
import com.anylogic.ssystem.bms.trn.service.BmsDctApprreqService;
...
@Api(tags = {"trn"})
@RestController
@RequestMapping("/bms/trn/bmsdctapprreq")
public class BmsDctApprreqController {
    ...
    /* 인계인수서 임시저장 */
//    @PostMapping(value = "/insertApprreq")
//    public ResponseEntity insertApprreq
//    (
...
//        int res = 0;
//        try {
//            res = bmsDctApprreqService.insertApprreq(param);
//        } catch (Exception e) {

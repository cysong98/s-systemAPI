...
@Setter
@ApiModel
public class BmsTrnCurrentListReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("기안자 부서ID")
    private String reqdeptid;                   // 기안자 부서ID

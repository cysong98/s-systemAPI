...
public class InsertTrnStepResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertTrnStepReqVO> selectList;                           //

...
@Setter
@ApiModel
public class InsetTrnObjectReqVO extends AnyXCommonVO implements Serializable {
    // bms_trn_object
    ...
    @ApiModelProperty("") private String selectdocid;                           //
    @ApiModelProperty("") private String selectdocttl;                           //
    @ApiModelProperty("") private String selectregirecvtype;
    @ApiModelProperty("") private String selectmgmtid;
    @ApiModelProperty("") private String selectdocno;
    @ApiModelProperty("") private String selectmgmtno;
    @ApiModelProperty("") private String selectseclevel;

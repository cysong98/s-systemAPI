...
@ApiModel("selectMgmtRegiSecStatusReClasscontCount")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectMgmtRegiSecStatusReClasscontCountResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String statdt;                                     // 
    @ApiModelProperty("") private BigDecimal auth12;                                     // 
    @ApiModelProperty("") private BigDecimal auth13;                                     // 
    @ApiModelProperty("") private BigDecimal auth14;                                     // 
    @ApiModelProperty("") private BigDecimal auth22;                                     // 
    @ApiModelProperty("") private BigDecimal auth23;                                     // 
    @ApiModelProperty("") private BigDecimal auth24;                                     // 
    @ApiModelProperty("") private BigDecimal auth32;                                     // 
    @ApiModelProperty("") private BigDecimal auth33;                                     // 
    @ApiModelProperty("") private BigDecimal auth34;                                     // 
    @ApiModelProperty("") private BigDecimal auth42;                                     // 
    @ApiModelProperty("") private BigDecimal auth43;                                     // 
    @ApiModelProperty("") private BigDecimal auth44;                                     // 
    @ApiModelProperty("") private BigDecimal auth52;                                     // 
    @ApiModelProperty("") private BigDecimal auth53;                                     // 
    @ApiModelProperty("") private BigDecimal auth54;                                     // 
}

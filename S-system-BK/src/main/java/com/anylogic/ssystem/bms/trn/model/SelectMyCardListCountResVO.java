...
@ApiModel("selectMyCardListCount")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectMyCardListCountResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("") private String pjtcardid;     // 
    @ApiModelProperty("") private String ownerid;       // 
    @ApiModelProperty("") private String ownername;     // 

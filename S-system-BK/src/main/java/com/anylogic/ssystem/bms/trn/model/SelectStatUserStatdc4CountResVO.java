...
@ApiModel("selectStatUserStatdc4Count")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectStatUserStatdc4CountResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("") private String usrid;                                  // 
    @ApiModelProperty("") private String orgid;                                  // 
    @ApiModelProperty("") private String autoflag;                               // 
    @ApiModelProperty("") private String statdt;                                 // 
    @ApiModelProperty("") private BigDecimal statcnt;                                //
    @ApiModelProperty("") private BigDecimal subcnt;                                 //
    @ApiModelProperty("") private BigDecimal statdct2;                               //
    @ApiModelProperty("") private BigDecimal statdct3;                               //
    @ApiModelProperty("") private BigDecimal statdct4;                               //
    @ApiModelProperty("") private BigDecimal statmemo;                               //

...
@Setter
@ApiModel
public class SelectTransProcDeptToDoListReqVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("제목")
    @Size(max=200)
    ...
    @ApiModelProperty("apprdeptid")
    private String apprdeptid;                       // apprdeptid

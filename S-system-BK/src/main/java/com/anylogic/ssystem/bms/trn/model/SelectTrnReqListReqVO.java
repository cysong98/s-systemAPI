...
@Setter
@ApiModel
public class SelectTrnReqListReqVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("제목")
    @Size(max=200)
    ...
    @Size(max=35)
    private String requserid;                //  유저아이디

    @ApiModelProperty("인계인수대상아이디")
    @Size(max=35)
    private String objectid;                //  인계인수대상아이디

    @ApiModelProperty("인계인수대상명")
    @Size(max=500)
    private String objectname;                //  인계인수대상명

...
@Setter
@ApiModel
public class InsertComingCnsrvApproveBIAReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertComingCnsrvApproveBIAReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertComingCnsrvApproveBIAReqVO> cnsrvList; // 존안요청 다건처리 용도
    @ApiModelProperty("관리번호") private String mgmtid;                  // 관리번호
    @ApiModelProperty("요청존안기간") private String reqcnsrvdt;          // 요청존안기간
    @ApiModelProperty("승인존안기간") private String grantcnsrvdt;        // 승인존안기간

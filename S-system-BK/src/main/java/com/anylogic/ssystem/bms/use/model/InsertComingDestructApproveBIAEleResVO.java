...
@ApiModel("insertComingDestructApproveBIA")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class InsertComingDestructApproveBIAEleResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("최종시현물존재여부") private String finalrfidexist;    // 최종시현물존재여부
}

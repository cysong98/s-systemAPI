...
@Setter
@ApiModel
public class InsertComingDestructApproveBIAReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertComingDestructApproveBIAReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertComingDestructApproveBIAReqVO>  destructList; // 재분류 테이블 다건처리 용도

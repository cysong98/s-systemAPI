...
@Setter
@ApiModel
public class InsertComingReclassApproveBIAReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertComingReclassApproveBIAReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertComingReclassApproveBIAReqVO>  reclassList; // 재분류 테이블 다건처리 용도

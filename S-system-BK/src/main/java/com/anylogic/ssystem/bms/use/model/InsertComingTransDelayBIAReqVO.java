...
@Setter
@ApiModel
public class InsertComingTransDelayBIAReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertComingTransDelayBIAReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertComingTransDelayBIAReqVO> transList; // 이관요청 다건처리 용도

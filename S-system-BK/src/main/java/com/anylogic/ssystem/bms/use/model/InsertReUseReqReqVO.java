...
@Setter
@ApiModel
public class InsertReUseReqReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertReUseReqReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertReUseReqReqVO> reuseList; // 재사용요청 테이블 다건처리 용도
    @ApiModelProperty("비밀관리 ID") private String mgmtid;                   // 비밀관리 ID
    @ApiModelProperty("요청열람 시작일시") private String reqreusebegindt;     // 요청열람 시작일시
    @ApiModelProperty("요청열람 만료일시") private String reqreuseenddt;       // 요청열람 만료일시
    @ApiModelProperty("승인열람 시작일시") private String grantreusebegindt;   // 승인열람 시작일시
    @ApiModelProperty("승인열람 만료일시") private String grantreuseenddt;     // 승인열람 만료일시

...
@Setter
@ApiModel
public class InsertTransWaitReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private String[] mgmtids;
    ...
    @ApiModelProperty("") private List<InsertTransWaitReqVO> rdocList; // rdoc 테이블 다건처리 용도
    @ApiModelProperty("") private String r_docid;
    @ApiModelProperty("") private String r_open;
    @ApiModelProperty("") private String r_readrangetype;
    @ApiModelProperty("") private String r_readlimittype;
    @ApiModelProperty("") private String r_transflag;

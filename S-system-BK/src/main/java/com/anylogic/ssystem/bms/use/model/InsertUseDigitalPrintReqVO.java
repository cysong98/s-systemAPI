...
@Setter
@ApiModel
public class InsertUseDigitalPrintReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertUseDigitalPrintReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertUseDigitalPrintReqVO> printList; // 인쇄요청 테이블 다건처리 용도
    @ApiModelProperty("관리번호") private String mgmtid;                    // 관리번호
    @ApiModelProperty("요청인쇄부수") private BigDecimal reqprtcnt;   // 요청인쇄부수
    @ApiModelProperty("요청파기예정일") private String reqdestructdt;       // 요청파기예정일
    @ApiModelProperty("승인인쇄부수") private BigDecimal grantprtcnt; // 승인인쇄부수
    @ApiModelProperty("승인파기예정일") private String grantdestructdt;     // 승인파기예정일
    @ApiModelProperty("인쇄부수") private BigDecimal prtcnt;          // 인쇄부수
    @ApiModelProperty("인쇄일시") private String prtdt;                     // 인쇄일시
    @ApiModelProperty("파기부수") private BigDecimal destructcnt;     // 파기부수
    @ApiModelProperty("파기일시") private String destructdt;                // 파기일시
    @ApiModelProperty("기관보안관리자") private String prtcharge;                // 기관보안관리자

    // 4) bms_dct_apprreq_prt_file
    @ApiModelProperty("") private List<InsertUseDigitalPrintReqVO> fileList; // 인쇄요청 첨부파일 테이블 다건처리 용도

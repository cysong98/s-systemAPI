...
@Setter
@ApiModel
public class InsertUseDigitalViewReqReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertUseDigitalViewReqReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertUseDigitalViewReqReqVO> readList; // 열람요청 테이블 다건처리 용도
    ...
    @ApiModelProperty("열람일시") private String readcharge;                      // 기관보안관리자

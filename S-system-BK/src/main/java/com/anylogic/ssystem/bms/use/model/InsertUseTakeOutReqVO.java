...
@Setter
@ApiModel
public class InsertUseTakeOutReqVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("") private List<InsertUseTakeOutReqVO> pathList; // 경로 테이블 다건처리 용도
    ...
    @ApiModelProperty("") private List<InsertUseTakeOutReqVO> lendList; // 반출요청 테이블 다건처리 용도
    ...
    // 4) bms_dct_apprreq_lend_fle table
    @ApiModelProperty("") private List<InsertUseTakeOutReqVO> fileList; // 인쇄요청 첨부파일 테이블 다건처리 용도

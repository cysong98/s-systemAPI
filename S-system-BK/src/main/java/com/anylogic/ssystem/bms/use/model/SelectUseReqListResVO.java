...
public class SelectUseReqListResVO extends AnyXCommonVO implements Serializable {
    @ApiModelProperty("결재요청 ID") private String apprreqid;                   // 결재요청 ID
    @ApiModelProperty("요청타입") private String reqtype;                        // 요청타입
    @ApiModelProperty("요청타입명") private String reqtypenm;                        // 요청타입
    ...
    @ApiModelProperty("진행상태명") private String reqstatusnm;                      // 진행상태
    ...
    @ApiModelProperty("부서명") private String deptname;
    @ApiModelProperty("직위") private String position;
    @ApiModelProperty("직급") private String grade;

...
@ApiModel("selectUseReqViewDetail")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectUseReqViewDetailResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("파일반출담당자") private String lendcharge;
    @ApiModelProperty("반출/반납여부확인") private String lendstatus;


    @ApiModelProperty("") private List<SelectUseReqViewPathListResVO> pathList;
    @ApiModelProperty("") private List<SelectUseReqViewListResVO> viewList;
    @ApiModelProperty("") private List<HashMap<String, Object>> mapList;

    @ApiModelProperty("경로체크") private String ingappcnt;// 경로정보 로그인 한 사람의 처리되지않은 이전값 있는지
}

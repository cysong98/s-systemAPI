...
public class SelectUseReqViewListResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("요청열람 시작일시 만료일시") private String reqreaddttran;        // 요청열람 만료일시
    ...
    @ApiModelProperty("제목") private String secttl;
    @ApiModelProperty("종류") private String regirecvtype;

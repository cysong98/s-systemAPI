...
@ApiModel("selectUseReqViewPathList")
@Getter
@Setter
@Builder
@AllArgsConstructor
...
public class SelectUseReqViewPathListResVO extends AnyXCommonVO implements Serializable {
    ...
    @ApiModelProperty("결재유형명") private String apprtypenm;                           // 결재유형
    @ApiModelProperty("결재처리구분") private String apprgubun;                      // 결재처리구분
    @ApiModelProperty("결재요청상태") private String apprstatus;                     // 결재요청상태
    @ApiModelProperty("결재요청상태명") private String apprstatusnm;                     // 결재요청상태
    ...
    @ApiModelProperty("부서명") private String positionnm;                             // 부서명
}

...
@Setter
@ApiModel
public class UpdateUseReqViewAppApproveReqVO extends AnyXCommonVO implements Serializable {
    // bms_dct_apprreq
    ...
    @ApiModelProperty("프린트리스트") private List<UpdateUseReqPrintApproveReqVO> prtlist;
    @ApiModelProperty("") private List<UpdateUseReqViewAppApproveReqVO> list;
    @ApiModelProperty("") private String savetype;
    @ApiModelProperty("결재자 ID") private String apprid;             // 결재자 ID
    @ApiModelProperty("요청구분용") private String isprintreq;                  // 요청구분용(인쇄/파쇄실행)

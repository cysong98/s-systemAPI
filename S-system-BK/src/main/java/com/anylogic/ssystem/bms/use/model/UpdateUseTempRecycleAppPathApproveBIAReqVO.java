...
@Setter
@ApiModel
public class UpdateUseTempRecycleAppPathApproveBIAReqVO extends AnyXCommonVO implements Serializable {
    // bms_dct_apprreq_path
    @ApiModelProperty("요청 ID") private String apprreqid;            // 요청 ID
    @Builder.Default
    @ApiModelProperty("요청경로순번") private double apprreqseq = -999999;// 요청경로순번

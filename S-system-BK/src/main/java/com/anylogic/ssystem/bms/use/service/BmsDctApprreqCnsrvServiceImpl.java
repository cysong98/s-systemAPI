...
import com.anylogic.ssystem.bms.use.mapper.BmsDctApprreqCnsrvMapper;
...
@Service("BmsDctApprreqCnsrvService")
@Transactional
public class BmsDctApprreqCnsrvServiceImpl implements BmsDctApprreqCnsrvService {
    ...
    public int insertComingCnsrvApproveBIA(InsertComingCnsrvApproveBIAReqVO param){
        int resInsertComingCnsrvApproveBIA = 0;
        String resSysGuid = "";
        ...
        try {
            ...
            for(InsertComingCnsrvApproveBIAReqVO tempReqVO : param.getPathList()) {
            ...
            // 03. INSERT BMS_DCT_APPRREQ_CNSRV TABLE
            String mgmtid = "";
            for(InsertComingCnsrvApproveBIAReqVO tempReqVO : param.getCnsrvList()) {
                tempReqVO.setReqcnsrvdt(tempReqVO.getReqcnsrvdt().replaceAll("\\.","")+ "235959");
                tempReqVO.setApprreqid(param.getApprreqid());
                tempReqVO.setGrantflag(param.getGrantflag());
                InsertComingCnsrvApproveBIAReqVO insertComingCnsrvApproveBIAReqParam = getApprreqCnsrvVO(tempReqVO);
                resInsertComingCnsrvApproveBIA += bmsDctApprreqCnsrvMapper.insertComingCnsrvApproveBIA(insertComingCnsrvApproveBIAReqParam);

                // 03-1. UPDATE BMS_DCT_MGMT_REGI TABLE
                mgmtid = tempReqVO.getMgmtid();
                if (param.getReqstatus().equals("1")) {
                    param.setSecstatus("MGT30"); // 존안 요청중
                } else if (param.getReqstatus().equals("6")) {
                    param.setSecstatus("MGT31"); // 존안 승인
                }
        ...
        return resInsertComingCnsrvApproveBIA;
    }

    // 01. INSERT BMS_DCT_APPRREQ TABLE
    private InsertDctApprReqReqVO getApprreqVO(InsertComingCnsrvApproveBIAReqVO vo, String indt){
    ...
    // 02. INSERT BMS_DCT_APPRREQ_PATH TABLE
    private InsertDctApprReqPathReqVO getApprreqPathVO(InsertComingCnsrvApproveBIAReqVO vo, String indt){
    ...
    // 03. INSERT BMS_DCT_APPRREQ_CNSRV TABLE
    private InsertComingCnsrvApproveBIAReqVO getApprreqCnsrvVO(InsertComingCnsrvApproveBIAReqVO vo){
        InsertComingCnsrvApproveBIAReqVO build = InsertComingCnsrvApproveBIAReqVO.builder()
                .apprreqid(vo.getApprreqid())
                .mgmtid(vo.getMgmtid())
                .reqcnsrvdt(vo.getReqcnsrvdt())
                .grantcnsrvdt(vo.getGrantcnsrvdt())
                .grantflag(vo.getGrantflag())
                .build();
        return build;
    }
    ...
    // 03-1. UPDATE BMS_DCT_MGMT_REGI TABLE
    private UpdateComingReqsMgmtReqVO getMgmtVO(InsertComingCnsrvApproveBIAReqVO vo, String mgmtid, String indt){
    ...
    // 04. INSERT BMS_DCT_HIST_CARD TABLE
    private InsertHistoryReqVO getHistoryVO (InsertComingCnsrvApproveBIAReqVO vo, String resDocid, String histSeq, String indt){

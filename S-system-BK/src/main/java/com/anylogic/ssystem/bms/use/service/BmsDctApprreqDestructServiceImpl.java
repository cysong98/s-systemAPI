...
import com.anylogic.ssystem.bms.use.mapper.BmsDctApprreqDestructMapper;
...
@Service("BmsDctApprreqDestructService")
@Transactional
public class BmsDctApprreqDestructServiceImpl implements BmsDctApprreqDestructService {
    ...
    /* 예고문도래목록 > 파기요청 > 파기요청서 등록 */
    @Transactional
    @Override
    public int insertComingDestructApproveBIA(InsertComingDestructApproveBIAReqVO param){
        int resInsertComingDestructApproveBIA = 0;
        String resSysGuid = "";
        ...
        try {
            ...
            for(InsertComingDestructApproveBIAReqVO tempReqVO : param.getPathList()) {
            ...
            // 03. INSERT BMS_DCT_APPRREQ_DESTRUCT TABLE
            String mgmtid = "";
            for(InsertComingDestructApproveBIAReqVO tempReqVO : param.getDestructList()){
                tempReqVO.setApprreqid(param.getApprreqid());
                tempReqVO.setGrantflag(param.getGrantflag());
                InsertComingDestructApproveBIAReqVO insertComingReclassApproveBIAParam = getDestructVO(tempReqVO);
                resInsertComingDestructApproveBIA += bmsDctApprreqDestructMapper.insertComingDestructApproveBIA(insertComingReclassApproveBIAParam);

                // 03-1. UPDATE BMS_DCT_MGMT_REGI TABLE
                mgmtid = tempReqVO.getMgmtid();
                if (param.getReqstatus().equals("1")) {
                    param.setSecstatus("MGT40"); // 파기 요청중
                } else if (param.getReqstatus().equals("6")) {
                    param.setSecstatus("MGT41"); // 파기 승인
                }
        ...
        return resInsertComingDestructApproveBIA;
    }

    // 01. INSERT BMS_DCT_APPRREQ TABLE
    private InsertDctApprReqReqVO getApprreqVO(InsertComingDestructApproveBIAReqVO vo, String indt){
    ...
    // 02. INSERT BMS_DCT_APPRREQ_PATH TABLE
    private InsertDctApprReqPathReqVO getApprreqPathVO(InsertComingDestructApproveBIAReqVO vo, String indt){
    ...
    // 03. INSERT BMS_DCT_APPRREQ_DESTRUCT TABLE
    private InsertComingDestructApproveBIAReqVO getDestructVO(InsertComingDestructApproveBIAReqVO vo){
        InsertComingDestructApproveBIAReqVO build = InsertComingDestructApproveBIAReqVO.builder()
                .apprreqid(vo.getApprreqid())
                .mgmtid(vo.getMgmtid())
                .grantflag(vo.getGrantflag())
                .build();
    ...
    // 03-1. UPDATE BMS_DCT_MGMT_REGI TABLE
    private UpdateComingReqsMgmtReqVO getMgmtVO(InsertComingDestructApproveBIAReqVO vo, String mgmtid, String indt){
    ...
    // 04. INSERT BMS_DCT_HIST_CARD TABLE
    private InsertHistoryReqVO getHistoryVO (InsertComingDestructApproveBIAReqVO vo,String resDocid, String histSeq, String indt){

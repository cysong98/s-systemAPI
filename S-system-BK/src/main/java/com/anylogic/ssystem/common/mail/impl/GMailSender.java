...
package com.anylogic.ssystem.common.mail.impl;

import com.anylogic.ssystem.common.exception.AnyXException;
import com.anylogic.ssystem.common.mail.MailConstants;
import com.anylogic.ssystem.common.mail.SendMail;
...
public class GMailSender implements SendMail {
    ...
    private static final String _authId = PropUtil.getInstance().getPropValue(MailConstants.DEFAULT_MAIL_TEMPLATE_PROPERTICE,
            MailConstants.MAIL_AUTH_ID);
    
    private static final String _authPw = PropUtil.getInstance().getPropValue(MailConstants.DEFAULT_MAIL_TEMPLATE_PROPERTICE,
...
//_authPw
        ...
        if(fromName != null){
            msg.setFrom(new InternetAddress(from, MimeUtility.encodeText(fromName, String.valueOf(String.valueOf(StandardCharsets.UTF_8)),"B")));
        }else {
     ...
     public String decryption(){
         ...
         return decryptor.decrypt("zNvkh91BGNo++PFRJbJ3YtKvJ3Wh8EtZ");

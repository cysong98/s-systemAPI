...
public class PropUtil {
    ...
    private static final HashMap<String, Object> HM_PROP = new HashMap<>();
...
//    }
    ...
    /**
     * @param propertiFilePath String
     * @param propCode String
     * @return String
     */
    ...
    public String getValues (String fileName, String propName){
        ...
        String value = null;
        try{
            value = prop != null ? prop.getProperty(propName, null) : null;
            value = Uni2Utf( value );
        }catch(Exception e){
            log.error("해당 properties["+propName+"]가 존재하지 않습니다.1==>" + fileName + "=="+ e);
        }
        return value;
    }
    ...
    public String Uni2Utf(String UnicodeStr) {
        try{
            if (UnicodeStr == null) {
                ...
                return new String(UnicodeStr.getBytes(StandardCharsets.ISO_8859_1), String.valueOf(StandardCharsets.UTF_8));
            }
        }catch( Exception e ) {

...
public class BmsDctAttrControllerTest extends ControllerTest {
    private final static String TEST_GETDCTATTR_URL = "/bmsdctattr/dct/bmsDctAttr/getDctAttr";
    ...
    @Test
    public int getDctAttr() throws Exception {
        // given
        GetDctAttrReqVO getDctAttrReqVO = GetDctAttrReqVO.builder()
//            .docid("")
            .build();

        // when
        mvc.perform(get(TEST_GETDCTATTR_URL)

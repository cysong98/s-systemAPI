...
public class BmsDctApprreqControllerTest extends ControllerTest {
    private final static String TEST_INSERTAPPRREQ_URL = "/bmsdctapprreq/trn/bmsDctApprreq/insertApprreq";
    ...
    @Test
    public int insertApprreq() throws Exception {
        // given
        InsertApprreqReqVO insertApprreqReqVO = InsertApprreqReqVO.builder()
            .apprreqid("")
            .build();

        String content = objectMapper.writeValueAsString(insertApprreqReqVO);

        // when
        mvc.perform(get(TEST_INSERTAPPRREQ_URL)

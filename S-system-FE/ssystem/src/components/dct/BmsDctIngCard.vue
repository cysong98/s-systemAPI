      ...
      <section class="section sticky">
        <div class="box-title">
          ...
          <div class="action-buttons">
            ...
            <v-btn class="button" @click="moveToBmsDctInglist()">목록</v-btn>
          </div>
        </div>
      </section>
      ...
      <!-- 비밀속성 -->
          ...
          <v-table :class="{ 'table-type-03-copydoc': isReceivedDoc, 'table-type-03': !isReceivedDoc }">
            ...
            <tbody>
              <tr>
                ...
                <th>내부생성<br>(사본없음)</th>
                <td><v-checkbox class="v-checkbox-square-btn" v-model="chkbox" hide-details="auto" :readonly="true"></v-checkbox></td>
              </tr>
              <tr>
              ...
              <tr>
                <th>
                  <!-- <div class="box-flex"> -->
                    붙임
                  <!-- </div> -->
                  <!-- <v-btn v-if="updateCardData.fileList.length >0" @click="downloadFileAll(updateCardData.fileList)">일괄다운</v-btn> -->
                </th>
                <td colspan="3">
        ...
        <section class="section">
          <div class="box-title">
            <h6 class="h6">관리정보</h6>
            <div class="action-buttons">
              <!-- <v-btn class="button" @click="dctReadDirectPopupToggleFunc()">열람지정</v-btn> -->
            </div>
          </div>
          <v-table :class="{ 'table-type-03-copydoc': isReceivedDoc, 'table-type-03': !isReceivedDoc }">
            <colgroup>

              ...
              <tr>
                ...
                <td colspan="7" >
                  ...
                  <div class="box-flex">
                    ...
                    <v-select
                      v-model="showOfflineData.prsrvterm"
                      :items="prsRvTermData"
              ...
              <tr>
                <td colspan="7">
                  ...
                  <div class="box-flex">
                    ...
                    <v-label>(으)로</v-label>
                    <v-select
                      v-model="showOfflineData.orgnreclass"
...
const name = ref('BmsDctProductOfflinecompletecard')
...
const orgnReclassSelected = computed(() => {
  if(showOfflineData.value.orgnreclass == '21'){
    return '일반문서';
  }else{
    return '선택'
  }
...
/* ============================================================ */
 ...
 const getDctAttr = async () => {
  try {
    ...
    showOfflineData.value.prsrvterm = data.prsrvterm ? (data.prsrvterm.trim() != "" ? data.prsrvterm : '') : '';
    showOfflineData.value.orgnprotdt = data.orgnprotdt;
    showOfflineData.value.orgnnextlevel = data.orgnnextlevel ;
    showOfflineData.value.orgnreclass = data.orgnreclass ? (data.orgnreclass.trim() != "" ? data.orgnreclass : '') : '';
    ...
    if(showOfflineData.value.orgnprotdt){
      sliceDates(showOfflineData.value.orgnprotdt, orgnDate.value);
      orgnProtDtPeriodSelected.value = (parseInt(orgnDate.value.year) - parseInt(showOfflineData.value.indt.slice(0,4))).toString();
    }
  } catch (error) {
    console.log(error);
    alert("Server Error");

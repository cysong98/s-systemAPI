    ...
    <div class="content">
      ...
      <div class="row">
        ...
        <div class="col border px-3">
          <template v-if="selectedAsktype === 'ORGEA'">
            <h3 class="h3">서명인</h3>
            <div class="box-image">
              <img
...
// 구분 라디오 버튼
const selectedAsktype = ref("ORGEA");
const radioData = [
  {view: "서명인", key:"ORGEA"},
  {view: "서명 생략", key:"ORGEB"},
]
// 라디오버튼 선택했을때의 펑션
...
const selectOrganizationInfo = async () => {
  ...
  try {
    const response = await API.dctAPI.selectSign({ ...selectOrganizationInfoCondi.value }, urlPaths.value);

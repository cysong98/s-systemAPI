...
const moveToBmsUseReqdetail = (row) => {
  ...
  }else if(reqtype === '04' || reqtype === '05'){
    moveName = 'BmsUsereqlenddetail'; // 반출(대출, 지출)
  ...
  const param = {apprreqid: "",reqtype:"",frompage:"BmsUsereqlist"};
